...
class OnBoardingModel {
  ...
  static List<OnBoardingModel> data = [
    OnBoardingModel(
      ...
      desc:
          'Pet care helps with a few simple steps to take care of your beloved pet on a daily basis',
    ),
    OnBoardingModel(
        svgPath: SvgAssets.secondOnBoarding,
        title: 'Shop easily',
        desc:
            'Get all pet accessories from one place by this app noe enjoy a hassle-free shopping',
        screen: const SecondOnBoardingScreen()),
    OnBoardingModel(
        svgPath: SvgAssets.thirdOnBoarding,
        title: 'Find vet quickly',
        desc:
            'Picking according to the veterinarian’s expert list is always at hand if your pet feels sick.',
        screen: FirstOnBoardingScreen()),
  ];
}
